...
// TODO: get this working, allow loading/unloading of models
...
var models = [
    ...
    {
        "title": "MH 370 ",
        "abstract": "Backward reconstruction of the MH370",
        "engine": "hycom",
        "videos": [
            "movies/mh370.webm",
            "movies/mh370.mp4"
...
_.each(textures, function(texture){
    ...
    $(texture.element).on('timeupdate', function(){
        if (texture.texture === null) {
            console.log('texture not yet loaded, skipping frame', texture);
            return;
        }
